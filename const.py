...
class Database:
    ...
    FAST_ETHERNET: Final[set[int]] = {52, 53, 54, 75, 301, 303, 330, 400, 490, 492, 494, 497, 503, 508, 509, 580, 582, 583, 586, 592, 598, 665, 666, 667, 1000, 1300, 1500, 2000}
...
class Country:
    ...
    BASE_SUBNET: Final[str] = os.getenv("COUNTRY_SUBNET")
